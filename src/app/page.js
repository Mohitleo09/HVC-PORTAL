...
import ReloadButton from "./components/ReloadButton"; // 👈 client component
...
const HomePage = async () => {
  ...
  // If no session and there's a database error
  if (!session && dbError) {
    return (
      <div className="min-h-screen flex items-center justify-center bg-gray-50">
        <div className="text-center p-8 bg-white rounded-lg shadow-lg max-w-md mx-4">
          <div className="mx-auto flex items-center justify-center h-12 w-12 rounded-full bg-yellow-100 mb-4">
            ...
            >
              <path
                ...
                strokeWidth={2}
                d="M12 9v2m0 4h.01m0 4h.01m-6.938 4h13.856c1.54 0 2.502-1.667 1.732-2.5L13.732 4c-.77-.833-1.964-.833-2.732 0L3.732 16.5c-.77.833.192 2.5 1.732 2.5z"
              />
            </svg>
          </div>
          ...
          <p className="text-gray-600 mb-6">
            The system is currently setting up the database. This may take a few
            moments.
          </p>

          <div className="space-y-3">
            <ReloadButton /> {/* 👈 client button */}
            <a
              href="/login"
      ...
      <div className="min-h-screen bg-gray-50">
        ...
        <div className="container mx-auto px-4 py-8">
          ...
          <p className="text-gray-600">
            Hello, {username}! You are logged in as a user.
          </p>
        </div>
      </div>
    );
